...
import userSearchSlice from 'src/store/slices/user-search.slice';
...
const UserSearchBox: React.FC = () => {
    ...
    const handleInputChange = (e: any) => {
        ...
        dispatch(
            userSearchSlice.actions.setUserSearchString({ substring: value }),
        );

        if (!value) {
            setSavedSearchSubstring('');
        }
    };
    ...
    return (
        <Box>
            ...
            />
            <Button onClick={handleSubmitClick} disabled={!user.searchString}>
                Search
            </Button>
